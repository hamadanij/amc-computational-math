# My AMC 12 Computational Lab Notebook

I am building Python calculators and simulators to pull the formulas apart, see why they work, and prove the math right in front of my eyes!

I’m teaching myself to code from scratch alongside my contest math preparation because I believe the best way to fully master a concept is to be able to thoroughly and clearly explain it to an audience with ground-zero knowledge. In this case, that audience is a computer —- a literal tabula rasa possessing zero innate intuition.
